...
class EfficientNet(nn.Module):
    ...
    def from_name(cls, model_name, heads, head_conv, pretrained=False):
        ...
        model = EfficientNet(blocks_args, global_params, heads, head_conv=head_conv)
        if pretrained:
...
def get_efficient_net(model_name, heads, head_conv=256):
  model = EfficientNet.from_name(model_name, heads, head_conv, pretrained=True)
  return model
